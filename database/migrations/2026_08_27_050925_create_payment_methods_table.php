 ...
 * number, a sort code. Changing where EduNest is paid meant editing a view and
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('payment_methods', function (Blueprint $table) {
            ...
            // holds what the EduNest Team can change about each one.
        ...
        DB::table('payment_methods')->insert([
            [
                ...
                'details' => json_encode([
                    'bank_name' => 'GTBank',
                    'account_name' => 'EduNest Technologies Ltd',
            ...
            [
                ...
                // is a row the EduNest Team can see and turn on when it works.
                'is_enabled' => false,
