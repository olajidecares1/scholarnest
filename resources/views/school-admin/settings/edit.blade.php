            ...
            <form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data" class="mt-4 space-y-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="field-hint mt-1">Browser tab icon for your public website (optional, square PNG recommended). Your school's own icon is never replaced with EduNest's.</p>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4 dark:border-gray-700">
                    ...
                    <p class="field-hint mt-0.5">Configure a school code and let EduNest generate unique Admission Numbers and Staff IDs automatically instead of typing them by hand.</p>
