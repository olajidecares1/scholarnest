        ...
        <div class="rounded-[5px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
            <div class="flex flex-wrap items-center gap-4">
                ...
                <div class="text-right">
                    ...
                    <p class="text-2xl font-extrabold text-gray-900 dark:text-white">{{ $average !== null ? $average.'%' : 'N/A' }}</p>
                </div>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse ($subjects as $subject)
                            ...
                            <tr class="transition-colors duration-200 hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $score ? $score->percentage().'%' : 'N/A' }}</td>
                                <td class="px-6 py-3">
                                    @if ($score)
