    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-3 lg:grid-cols-4">
            @foreach ([
                ...
                <a @if ($link) href="{{ $link }}" @endif class="rounded-[5px] border border-gray-200 bg-white p-4 shadow-sm transition dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px] {{ $link ? 'hover:border-primary-300' : '' }}">
                    <p class="flex items-center gap-2 text-[12px] font-semibold text-gray-500 dark:text-gray-400">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ $school->publicUrl('public.jobs.index') }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-[8px] border border-gray-300 px-3 py-2 text-[13px] font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
                    <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i>
                    View your Job Portal
                </a>
                <a href="{{ route('careers.applications.index') }}" class="inline-flex items-center gap-2 rounded-[8px] border border-gray-300 px-3 py-2 text-[13px] font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
                    <i class="fa-solid fa-users" aria-hidden="true"></i>
                    All applications
                </a>
            </div>
            <a href="{{ route('careers.create') }}" class="inline-flex items-center gap-2 rounded-[8px] bg-primary-600 px-4 py-2 text-[13px] font-bold text-white hover:bg-primary-700">
        ...
        <div class="rounded-[5px] border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
            ...
            @if ($jobs->isEmpty())
                <div class="p-10 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Create your first vacancy, publish it, and share its link to start receiving applications.</p>
                </div>
            @else
                    ...
                    @foreach ($jobs as $job)
                        <li class="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-[12.5px] text-gray-500 dark:text-gray-400">
                            ...
                            <div class="flex shrink-0 flex-wrap items-center gap-2">
                                <a href="{{ route('careers.show', $job) }}" class="inline-flex items-center gap-1.5 rounded-[8px] bg-primary-50 px-3 py-1.5 text-[12.5px] font-bold text-primary-700 hover:bg-primary-100 dark:bg-primary-900/30 dark:text-primary-300">
                                    <i class="fa-solid fa-users" aria-hidden="true"></i>
                                ...
                                <a href="{{ route('careers.edit', $job) }}" class="inline-flex items-center gap-1.5 rounded-[8px] border border-gray-300 px-3 py-1.5 text-[12.5px] font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
