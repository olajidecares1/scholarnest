            ...
            <div class="rounded-[5px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
                ...
                @if ($report->media_path)
                    <a
                        ...
                        class="mt-4 inline-flex items-center gap-2 rounded-[2px] border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 transition-all duration-200 hover:-translate-y-0.5 hover:bg-gray-50 hover:shadow-sm dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700"
                    >
        ...
        <div class="space-y-4">
            ...
            <div class="rounded-[5px] border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
                ...
                <form method="POST" action="{{ route('super-admin.reports.update', $report) }}" class="mt-4 space-y-4">
                    ...
                    <button
                        type="submit"
                        class="w-full rounded-[2px] bg-gray-900 px-4 py-2 text-sm font-semibold text-white transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-gray-800 hover:shadow-md dark:bg-gray-700 dark:hover:bg-gray-600"
                    >
                        Update Report
                    </button>
                </form>
