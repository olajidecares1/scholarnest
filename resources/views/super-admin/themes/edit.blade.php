...
<x-super-admin-layout page-title="Themes" page-subtitle="Customize the platform's color theme, logo, and favicon.">
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        >
            ...
            <small class="field-hint mt-1">Pick a palette. Preview updates instantly; save to apply platform-wide.</small>
            ...
            <form method="POST" action="{{ route('super-admin.themes.update') }}" class="mt-4 space-y-2">
                ...
                <div class="rounded-[5px] border border-dashed border-gray-300 p-4 dark:border-gray-600 lg:rounded-[10px]">
                    <small class="block text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Live Preview</small>
        ...
        <div class="rounded-[5px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
            ...
            <small class="field-hint mt-1">PNG, JPG or WebP. Max 10MB.</small>
        ...
        <div class="rounded-[5px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
            ...
            <small class="field-hint mt-1">PNG or ICO. Max 2MB.</small>
