<x-super-admin-layout :page-title="$section['title']" :page-subtitle="$section['description']">
    <div class="mx-auto max-w-2xl">
        <div class="rounded-[5px] border border-gray-200 bg-white p-8 text-center shadow-sm lg:rounded-[10px]">
            ...
            <h2 class="mt-4 text-xl font-bold text-gray-900">{{ $section['title'] }} — Coming Soon</h2>
