    ...
    >
        ...
        <div x-show="mode === 'manage'" x-data="{
            ...
            <div class="flex justify-end">
                <button type="button" @click="openAdd()" class="btn flex items-center gap-2 rounded-[8px] bg-primary-500 px-4 py-2 text-sm font-semibold text-white transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-primary-600 hover:shadow-md">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="mt-1 w-full"
                            >
                            <small class="field-hint mt-1">For diagrams, charts, or images referenced in the question. Leave blank to keep the existing image when editing.</small>
                        </div>
        ...
        <div x-show="mode === 'preview'" style="display: none;">
            <div class="flex items-center justify-between rounded-[5px] border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
                <div>
                    ...
                    <small class="field-hint">This is a QA preview for admins. Nothing is saved.</small>
                </div>
