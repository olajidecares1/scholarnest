    ...
    >
        ...
        <div x-show="mode === 'manage'" x-data="{
            ...
            <div class="flex justify-end">
                <button type="button" @click="openAdd()" class="flex items-center gap-2 rounded-[8px] bg-primary-500 px-4 py-2 text-sm font-semibold text-white transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-primary-600 hover:shadow-md">
                ...
                <div @click.outside="open = false" class="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-[8px] bg-white p-6 dark:bg-gray-800">
                    ...
                    >
                        ...
                        <div class="flex justify-end gap-2">
                            ...
                            <button type="submit" class="rounded-[8px] bg-primary-500 px-4 py-2 text-sm font-semibold text-white hover:bg-primary-600">Save Question</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div x-show="mode === 'preview'" style="display: none;">
            ...
            <template x-if="!previewSubmitted">
                <div class="mt-4 space-y-4">
                    ...
                    <button type="button" @click="submitPreview()" class="rounded-[8px] bg-primary-500 px-5 py-2.5 text-sm font-bold text-white shadow-md shadow-primary-500/30 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-primary-600 hover:shadow-lg">
                        Submit
                    </button>
                </div>
            </template>
