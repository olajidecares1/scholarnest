                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse ($schools as $school)
                            <tr>
                                <td class="px-5 py-3">
                                    <a href="{{ route('super-admin.schools.show', $school) }}" class="font-semibold text-gray-900 hover:text-primary-500 dark:text-white dark:hover:text-primary-400">{{ $school->name }}</a>
                                ...
                                <td class="px-5 py-3">
                                    <div class="flex items-center gap-2">
                                        <a href="{{ route('super-admin.schools.show', $school) }}" class="rounded-[5px] border border-gray-300 px-3 py-1.5 text-xs font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700 lg:rounded-[10px]">View</a>
                                        @if ($school->is_active)
