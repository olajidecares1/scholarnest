        ...
        <div>
            <div class="rounded-[5px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
                ...
                <form method="POST" action="{{ route('super-admin.communications.store') }}" class="mt-4 space-y-4">
                    ...
                    <button
                        type="submit"
                        class="flex w-full items-center justify-center gap-2 rounded-[2px] bg-primary-500 px-5 py-2.5 text-sm font-bold text-white shadow-md shadow-primary-500/30 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-primary-600 hover:shadow-lg"
                    >
                        Send Announcement
                    </button>
                </form>
