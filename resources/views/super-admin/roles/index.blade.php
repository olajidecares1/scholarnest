<x-super-admin-layout page-title="Roles & Permissions" page-subtitle="Manage admin roles and your AkademicNest Team team.">
    <div class="space-y-6">
        @if (session('status'))
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-5 py-10 text-center text-sm text-gray-500 dark:text-gray-400">No custom roles yet. Team members without a role have full AkademicNest Team access.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
