<x-super-admin-layout page-title="Add Team Member" page-subtitle="Grant another admin ScholarNest Team access.">
        ...
        <div class="rounded-[5px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-[10px]">
            <form method="POST" action="{{ route('super-admin.roles.team.store') }}" class="space-y-2">
                ...
                <x-text-field
                    ...
                    helper="The person you're granting ScholarNest Team access to."
                    :value="old('name')"
                    required
                    autofocus
                    autocomplete="name"
