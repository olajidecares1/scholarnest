            ...
            <div class="mx-auto mt-14 max-w-3xl border-t border-gray-100 pt-10">
                ...
                <div class="mt-4 space-y-3">
                    @foreach ($otherPosts as $other)
                        <a href="{{ $school->publicUrl('public.school-news.show', ['post' => $other]) }}" class="flex items-center justify-between gap-3 rounded-[8px] p-2 transition-colors duration-150 hover:bg-gray-50">
