<x-auth-layout :simple="true" :header="false" :title="'Staff Portal · '.$school->name" :school="$school" pwaPortal="staff">
    <x-auth-card>
        <div class="text-center">
            ...
            <small class="block text-xs font-semibold uppercase tracking-wide text-primary-500">Staff Portal</small>
        </div>
        ...
        <form method="POST" action="{{ url()->current() }}" class="mt-6 space-y-2">
            ...
            <small class="block text-center text-xs text-gray-500">Don't have your login details? Ask your school office for your Staff ID and portal password.</small>
