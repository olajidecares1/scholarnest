        ...
        <div class="flex items-start">
            ...
            <textarea
                ...
                {{ $attributes->except('id')->merge([
                    'class' => 'w-full min-w-0 resize-y border-0 bg-transparent py-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-0 dark:text-white dark:placeholder:text-gray-500 '
                        . ($icon ? 'pl-0 pr-4' : 'px-4'),
                ]) }}
