...
<div class="rounded-[10px] border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div class="min-w-0">
            ...
            <small class="block mt-1.5 max-w-2xl text-[12.5px] leading-[1.7] text-gray-500 dark:text-gray-400">
            ...
            @if ($totalCount > 0)
                <small class="block mt-3 text-[12px] font-semibold text-gray-600 dark:text-gray-300">
        ...
        <form method="POST" action="{{ $pushClassUrl }}" class="shrink-0">
            ...
            <button
                type="submit"
                class="btn flex h-[38px] items-center justify-center gap-2 rounded-[8px] bg-primary-600 px-4 text-[13px] font-bold text-white transition hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500/40"
            >
