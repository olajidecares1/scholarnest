<div class="space-y-3">
    @foreach ([
        ...
        <button
            ...
            disabled
            title="Coming soon"
            class="flex w-full cursor-not-allowed items-center justify-center gap-3 rounded-[8px] border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm"
        >
