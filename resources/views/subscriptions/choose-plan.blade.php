        ...
        >
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                @foreach ($plans as $plan)
                    <label
                        class="relative flex cursor-pointer flex-col rounded-[5px] border-2 bg-white p-6 shadow-sm transition lg:rounded-[10px]"
                    ...
                    >
                        ...
                        <div class="mt-4 rounded-[5px] bg-gray-50 p-4 lg:rounded-[10px]">
                            ...
                            @elseif ($plan->key->value === 'basic')
                                ...
                                <div class="mt-3" x-show="planId === {{ $plan->id }}" x-cloak>
                                    ...
                                    <input
                                        ...
                                        min="1"
                                        class="mt-1 w-full rounded-[5px] border-gray-300 py-2 text-sm shadow-sm focus:border-primary-500 focus:ring-primary-500 lg:rounded-[10px]"
                                    >
                            ...
                            @else
                                <div x-show="planId === {{ $plan->id }}" x-cloak class="mb-3 flex rounded-[5px] bg-white p-1 text-xs font-semibold lg:rounded-[10px]">
                                    <button type="button" @click="billingCycle = 'monthly'" :class="billingCycle === 'monthly' ? 'bg-primary-500 text-white' : 'text-gray-500'" class="flex-1 rounded-[5px] px-3 py-1.5 lg:rounded-[10px]">Monthly</button>
                                    <button type="button" @click="billingCycle = 'per_term'" :class="billingCycle === 'per_term' ? 'bg-primary-500 text-white' : 'text-gray-500'" class="flex-1 rounded-[5px] px-3 py-1.5 lg:rounded-[10px]">Per Term</button>
                                </div>
                        ...
                        <div
                            class="mt-6 w-full rounded-[5px] border-2 px-4 py-2.5 text-center text-sm font-semibold transition lg:rounded-[10px]"
            ...
            <div class="mt-8 flex justify-end">
                <button
                    ...
                    class="flex items-center gap-2 rounded-[5px] px-6 py-3 text-sm font-bold text-white shadow-md transition lg:rounded-[10px]"
                >
                    Continue
