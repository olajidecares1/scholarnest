        ...
        <x-auth-card class="!max-w-none">
            ...
            <form method="POST" action="{{ route('subscriptions.payment-method.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6" x-data="{ method: 'bank_transfer' }">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <label class="flex cursor-pointer items-start gap-3 rounded-[5px] border-2 border-primary-500 bg-primary-50 p-4 lg:rounded-[10px]">
                    ...
                    <label class="flex cursor-not-allowed items-start gap-3 rounded-[5px] border border-gray-200 bg-gray-50 p-4 opacity-60 lg:rounded-[10px]">
                ...
                <div>
                    ...
                    <label
                        for="receipt"
                        class="mt-3 flex cursor-pointer flex-col items-center justify-center rounded-[5px] border-2 border-dashed border-gray-300 bg-gray-50 px-4 py-8 text-center hover:border-primary-400 lg:rounded-[10px]"
